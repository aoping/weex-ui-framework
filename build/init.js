...
let ipIndexUrl = `http://${ip}:8081/dist/weex/views/HotelIndex.js`
let androidIndexUrl = argv._[0] === 'local' ? 'dist/weex/views/HotelIndex.js' : ipIndexUrl
...
// iOS 主机地址操作
let iOSConfigFile = path.join(__dirname, '../platforms/ios/WeexDemo/IpDefine.h')
let iosIndexDefine = argv._[0] === 'local' ? '[NSString stringWithFormat:@"file://%@/bundlejs/weex/views/HotelIndex.js",[NSBundle mainBundle].bundlePath]' : `[NSString stringWithFormat:@"${ipIndexUrl}"]`
