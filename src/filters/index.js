 ...
 * @author zoro
 * @date 2017/12/18
 * @description 1249 => ¥1,249    1249.3 => ¥1,249.30
 * 格式：currencyInt(1249, '¥')
 * @return String ¥1,249
 */
export function currencyFormator (price, symbol) {
  if (price === null || price === undefined) {
    return ''
  }
  ...
  return symbol + currencyList.reverse().join('') + (priceArr[1] === '00' || priceArr[1] === '0000' ? '' : '.' + priceArr[1].substr(0, 2))
}
